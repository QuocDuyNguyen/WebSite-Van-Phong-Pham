      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3rem] overflow-hidden shadow-2xl shadow-primary/5">
        ...
        <div className="hidden lg:block relative">
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            <h2 className="text-4xl font-bold mb-4">Join The Atelier</h2>
            <p className="text-white/80 leading-relaxed">
              Create an account to track orders, save your wishlist, and get exclusive access.
            </p>
          </div>
        </div>
        ...
        <div className="p-12 md:p-20 flex flex-col justify-center">
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-[#1A237E] mb-2">Sign Up</h1>
            <p className="text-on-surface-variant">Enter your details to create an account.</p>
          </div>

          {error && (
            <div className="p-4 mb-6 bg-red-50 text-red-600 rounded-2xl flex items-center gap-3 text-sm font-bold">
